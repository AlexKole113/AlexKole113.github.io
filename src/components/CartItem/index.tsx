...
const CartItem = ({title, image, price, currency, addItemProduct, removeItemProduct, removeProduct }:{title:string,image:string, price:number, currency: string, addItemProduct: () => void ,removeItemProduct:() => void, removeProduct:() => void  }) => (
    <div className={cartItemCss['cart-item']}>
        ...
        <div className={cartItemCss['cart-item__price-amount-group']} >
            ...
            <div className={cartItemCss['cart-item__amount']} >
                ...
                <input type="text" className={cartItemCss['cart-item__amount_current']} value="1" onChange={()=>{}} />
